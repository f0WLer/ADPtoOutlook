# TimeOffCalendar - ADP Time Off to Outlook Calendar

This tool converts an Excel file with ADP time off requests into a professional, company-wide Outlook calendar for easy visibility of all employee time off.
...
```powershell
# Basic usage
python src/excel_to_outlook.py timeoff.xlsx

# Clear calendar before import
python src/excel_to_outlook.py timeoff.xlsx --clear

# Verbose event titles (include reason)
python src/excel_to_outlook.py timeoff.xlsx --verbose

# Import only a date range
python src/excel_to_outlook.py timeoff.xlsx --range 02-01-2026 02-14-2026

# Combine options
python src/excel_to_outlook.py timeoff.xlsx --clear --verbose --range 01-01-2026 12-31-2026
```
